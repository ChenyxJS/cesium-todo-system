...
//    REQUEST_ERROR_ACTIVITI_UPDATE_DB("activiti生成成功，但是修改数据库出错，请重试。", "10019"),
    ...
    REQUEST_ERROR_HAVE_WARNING_DATA("预警条目已存在","10035"),
    REQUEST_ERROR_START_VOTE("开启投票失败","10036"),
    REQUEST_ERROR_STARTED_VOTE("投票已开启","10037"),
    REQUEST_ERROR_NO_START_VOTE("投票未开启","10038"),
    REQUEST_ERROR_AUDIT_PASS("审核已通过","10039"),
    REQUEST_ERROR_VOTED("不能重复投票","10040")
