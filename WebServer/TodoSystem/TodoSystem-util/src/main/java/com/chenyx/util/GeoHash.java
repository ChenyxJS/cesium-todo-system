...
public class GeoHash {
    ...
    public static ArrayList<String> getArroundGeoHash(double lat, double lon){
...
//        String s = geohash.encode(40.22094726562512345, 116.24633789062512345);
//        System.out.println(s);
//        double[] geo = geohash.decode(s);
//        System.out.println(geo[0]+" "+geo[1]);
//
//        List<String> a = geohash.getArroundGeoHash(40.2209472656251234, 116.2463378906251234);
//        for (String item:a){
