...
public class EmailUtil {
     ...
     */
    static String filePath = EmailUtil.class.getClassLoader().getResource("Email.properties").getPath();//获取发布服务器配置文件,注意必须是utf-8
    public static String host = PropertiesUtil.GetValueByKey(filePath, "host");
    public static String sender = PropertiesUtil.GetValueByKey(filePath, "sender");
    public static String senderpassword = PropertiesUtil.GetValueByKey(filePath, "senderpassword");
    public static String emailtitle = PropertiesUtil.GetValueByKey(filePath, "emailtitle");
/*    public static String host = "smtp.exmail.qq.com";
    public static String sender = "qianchengwandian@qingwacity.com";
    public static String senderpassword = "Zmllyj13141";*/
